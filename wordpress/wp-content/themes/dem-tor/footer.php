            ...
            <div class="stat-card md:bg-gradient-to-tr md:from-[#11C6DB] md:from-[-10%] md:to-[#e7e2d6] md:to-70% rounded-none md:rounded-[3rem] pt-16 pb-0 px-0 md:p-14 mb-8 md:mb-12 shadow-none md:shadow-2xl md:shadow-[#11C6DB]/20 flex flex-col justify-end items-center md:items-start relative overflow-visible md:overflow-hidden group">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 relative z-10 w-full">
                    ...
                    <div class="flex flex-col items-center md:items-start justify-center text-center md:text-left px-6 md:px-0">
                        ...
                        <div class="relative mt-4 md:mt-8 pl-0 md:pl-12 space-y-6 md:space-y-6 max-w-[320px] mx-auto md:mx-0 w-full text-center md:text-left">
                            
                            <!-- Address Item -->
                            <div class="relative flex flex-col md:flex-row items-center md:items-start group">
                                <div class="md:absolute md:-left-[64px] md:top-0.5 flex items-center justify-center w-8 h-8 md:w-10 md:h-10 bg-transparent md:bg-[#e7e2d6]/50 rounded-none md:rounded-xl shadow-none md:shadow-sm border-none md:border md:border-[#111111]/5 text-[#004562] mb-1 md:mb-0">
                                ...
                                <span class="text-[#004562] font-sans text-base md:text-lg font-normal md:font-bold leading-relaxed text-center md:text-left">Mimar Sinan Mah. Cendere Yolu. No: 49 Eyüpsultan / İstanbul</span>
                            </div>
                            
                            <!-- Phone Item -->
                            <div class="relative flex flex-col md:flex-row items-center group">
                                <div class="md:absolute md:-left-[64px] md:top-1/2 md:-translate-y-1/2 flex items-center justify-center w-8 h-8 md:w-10 md:h-10 bg-transparent md:bg-[#e7e2d6]/50 rounded-none md:rounded-xl shadow-none md:shadow-sm border-none md:border md:border-[#111111]/5 text-[#004562] mb-1 md:mb-0">
                                ...
                                <a href="tel:+902122897317" class="text-[#004562] font-sans text-base md:text-lg font-normal md:font-bold hover:opacity-70 transition-opacity tracking-tight">+90 212 289 73 17</a>
                            </div>
                            ...
                            <div class="relative flex flex-col md:flex-row items-center group">
                                ...
                                <a href="mailto:info@dem-tor.com.tr" class="text-[#004562] font-sans text-base md:text-lg font-normal md:font-bold hover:opacity-70 transition-opacity">info@dem-tor.com.tr</a>
                            </div>
                        </div>
                    </div>

                    <!-- Right Side: Google Map Box Component -->
                    <div class="h-[350px] md:h-[420px] w-[100vw] relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] md:w-full md:left-auto md:right-auto md:ml-0 md:mr-0 md:static md:translate-x-0 rounded-none md:rounded-[2rem] overflow-hidden p-0 md:p-1.5 group md:bg-white/20 border-y md:border md:border-white/30 md:shadow-inner md:backdrop-blur-sm mt-8 md:mt-0">
                        <iframe 
